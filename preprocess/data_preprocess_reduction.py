...
def get_oar_roi_indexes_modified(ds, oar_dict, Plan_Dx):
    ##!! AI_RTP: place to add matching rules LY  important to find ROI names
    new_oar_dict = {}
...
def fill_planar_contour_as_mask(pixel_coords, mask3d):
    ...
    ## Could replace this function with scilit-image polygon2mask
    ...
    image_shape = np.int32(mask3d.shape[1]), np.int32(mask3d.shape[2])
    img = draw.polygon2mask(image_shape,poly)
...
## AI_RTP: Here are the list of the OARs to extract contours and DVHs
